class User < ApplicationRecord
    ...
    has_secure_password
    validates :password, presence: true, length: { minimum: 6 }, allow_nil: true #allow validation for empty passwords    
   ...
   def send_password_reset_email
    UserMailer.password_reset(self).deliver_now#mailers method to reset password
   end
  ...
  #creates and allocates activation token and digest
